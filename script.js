...
class App {
  ...
  _loadMap(position) {
    ...
    // console.log(map); // look at the internals
  ...
  _getLocalStorage() {
    ...
    this.#workouts.forEach(work => {
      ...
      // this._renderWorkoutMarker(work); // won't work because the map is not yet loaded, transfer this code to _loadMap()
    });
  }
...
// Edits on Lecture 232
// map.on() instead of addEventListener()
// L.marker methods
...
// lots of binding function. e.g. Handling clicks on map
// this.#map.on('click', this._showForm.bind(this));
